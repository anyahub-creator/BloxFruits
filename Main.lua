...
Main:AddButton({
    ...
    Callback = function()
        pcall(function()
            setclipboard("https://discord.gg/F6jhXNvPtV")
        end)
    end
})
Main:AddParagraph({
...
game.StarterGui:SetCore("SendNotification", {
    ...
    Icon = "rbxassetid://136103435617044";
    Duration = 1e5;
	Button1 = "Yes";
	Button2 = "No";
})
...
ImageLabel.Image = "http://www.roblox.com/asset/?id= 136103435617044"
